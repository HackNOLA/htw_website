        ...
        <Row className="justify-content-center">
          <Col lg={6} md={8}>
            <div className="title text-center mb-5">
              ...
              <p className="text-muted"><span className="text-primary font-weight-medium"></span>Our technical training programs, HackNOLA and HTW Univeristy, teaches the necessary skills to construct dapps (decentralized applications) and software development fundamentals. <span className="text-primary font-weight-medium">No prior experiance required.</span></p>
            </div>
          </Col>
        </Row>
        <Row>
