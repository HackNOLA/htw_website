...
const Team = () => {
    ...
    <div>
        ...
        <Col lg={6} md={8}>
            <Media body>
                <img width={250} facebook-id="invalidfacebookusername" src="https://avatars.githubusercontent.com/u/33336793?v=4" />
        ...
        <Media className="mt-1">
            <Col lg={6} md={8}>
                <Media body>
                    <img width={250} facebook-id="invalidfacebookusername" src="https://avatars.githubusercontent.com/u/42776703?s=400&u=3108ae3a708ef0219e72e93e9f5788ed3813b8d4&v=4" />
