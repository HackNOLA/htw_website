...
<VerticalTimelineElement
  ...
  >
    ...
    <p>
      We plan to utilize the Famtom network for a scalability and secure, low-cost transactions
    </p>
  </VerticalTimelineElement>
  <VerticalTimelineElement
    className="vertical-timeline-element--work"
  ...
  >
    ...
    <p>
      We having our first class for our Intro to Software Development course in October, 2021. There are a limited number of seats available for our first cohort; therefore, if you're applicant number is #30 and above, you will be enrolled in our waitlist for our upcoming classes  
    </p>
  </VerticalTimelineElement>
  <VerticalTimelineElement
    className="vertical-timeline-element--work"
  ...
  >
    ...
    <p>
        A Hack the World listing on a major international digital currency exchange usually results in a price boost for the token. This will also help the growth of the Hack the World community and utility 
    </p>
  </VerticalTimelineElement>
  <VerticalTimelineElement
