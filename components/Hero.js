        ...
        <Row className="align-items-center">
          <Col lg={6}>
            <div className="pr-lg-5">
              ...
              <p className="text-muted mb-4 pb-2">Hack the World is a tech ecosystem, helping thousands of underserved people worldwide in building a community of blockchain enthusiasts. Our ecosystem encompasses our techincal training program, <span className="text-primary font-weight-medium">HackNOLA</span>.</p>
              <a href="#sign-up" className="btn btn-warning">
